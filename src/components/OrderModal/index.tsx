...
const OrderModal = ({ open, setOpen }: OrderModalProps) => {
  ...
  return (
    <div
      className={`${
        open ? "block" : "hidden"
      } fixed inset-0 z-50 flex items-center justify-center overflow-scroll`}
    >
      {/* Backdrop */}
      <div
      ...
      {/* Modal Content */}
      <div className="relative w-[586px]  bg-white rounded-lg">
        ...
        <div className="p-4">
          ...
          <div className="border-b border-dashed border-[#717680] text-slate-700 py-3 space-y-2">
            ...
            <p className="flex items-center justify-between ">
              <span>Change</span> <span className="font-semibold">-$55.00</span>
            </p>
